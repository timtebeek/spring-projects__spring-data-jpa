...
/*
    ...
    This is JPA 3.1 BNF. There are gaps and inconsistencies in the BNF itself, explained by other fragments of the spec.

    @see https://github.com/jakartaee/persistence/blob/master/spec/src/main/asciidoc/ch04-query-language.adoc#bnf
    @author Greg Turnquist

    @see https://stackoverflow.com/questions/7527232/antlr-header-parser-superclass-option-and-basic-file-io-java for options
 */
...
// The following[2] are reserved identifiers:
