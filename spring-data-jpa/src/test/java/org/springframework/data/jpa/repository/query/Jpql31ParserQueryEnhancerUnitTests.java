...
/**
 * TCK Tests for {@link Jpql31ParserQueryEnhancer}.
 *
 * @author Mark Paluch
 */
public class Jpql31ParserQueryEnhancerUnitTests extends QueryEnhancerTckTests {
	...
	QueryEnhancer createQueryEnhancer(DeclaredQuery declaredQuery) {
		return new Jpql31ParserQueryEnhancer(declaredQuery);
	}
